...
export let useCustomTableName=function(sequelize: any, sequelizeModel:any,value:string, isColumn:boolean=true,generatePostfixFunc?:Function,targetHooks?:string[]){
